...
<body>
   ...
   <div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-30 p-l-15-sm">
      <a href="index.html" class="s-text16"> Home <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i></a> 
      <a href="product.html" class="s-text16"> ${product.getCategoryId()} <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i></a> 
      <a href="#" class="s-text16"> ${product.getName()} <i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i></a> 
      <span class="s-text17"> ${item.getItemId()}</span>
   </div>
   ...
   <div class="container bgwhite p-t-35 p-b-80">
      <div class="flex-w flex-sb">
         ...
         <div class="w-size14 p-t-30 respon5">
            ...
            <div class="p-b-45">
               <span class="s-text8 m-r-35">SKU: ${item.getItemId() }</span>
               <span class="s-text8">Categories: ${product.getCategoryId() }, Pet</span>
            </div>
            ...
            <div class="wrap-dropdown-content bo7 p-t-15 p-b-14">
               <h5 class="js-toggle-dropdown-content flex-sb-m cs-pointer m-text19 color0-hov trans-0-4">
                  <a style="text-decoration:none;color:black;"  href="<c:url value="/p2p/viewSellerPage.do">
                  <c:param name="userId" value="${userId}"/></c:url>"> 판매자 페이지[${userId}]</a>
               </h5>
            </div>

            <div class="wrap-dropdown-content bo7 p-t-15 p-b-14">
               <h5 class="js-toggle-dropdown-content flex-sb-m cs-pointer m-text19 color0-hov trans-0-4">Q&A</h5>
            </div>
            ...
            <div class="wrap-dropdown-content bo7 p-t-15 p-b-14" id = "hiddenBtn">
               <button class="size9 bg4 bo-rad-23 hov1 s-text1" id="deleteBtn" style="display:none">삭제 </button>
               &nbsp;&nbsp;
               <button class="size9 bg4 bo-rad-23 hov1 s-text1"  id="updateBtn" value = "modify" style="display:none" onClick="btnSubmit(this.value)">수정 </button>
			</div>
         </div>
      </div>
     </div>
