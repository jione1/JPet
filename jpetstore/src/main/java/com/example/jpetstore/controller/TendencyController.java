...
public class TendencyController {
	...
	public String tendencyStart(ModelMap model) throws Exception{
		...
		return "tiles/testTendency";		 	
	}


	@RequestMapping("/tendency/sendResult.do")
	public String tendencyResult(@ModelAttribute("testTendency")Tendency tendency) throws Exception {
		return "tiles/resultTendency";
	}
...
//		
//		//tendency.properties에서 설정한 질문 별 결과성향을 받아온다
//		//Tendency_WhatKind Bean객체 받아오기 
//			String configLocation = "dataAccessContext-mybatis.xml";
//			ApplicationContext ctx = new ClassPathXmlApplicationContext(configLocation);
//			Tendency_WhatKind kindBean = ctx.getBean("result", Tendency_WhatKind.class);
//		
